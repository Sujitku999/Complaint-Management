...
<?php
    ...
    if($res==true){
        ...
        if($count==1){
            ...
            $msg = "<div class='suck1'>USER NOT FOUND</div>";
...
if(isset($_POST['submit'])){
   ...
   ";
    ...
    $res=mysqli_query($conn,$sql);
    if($res==true){
        $_SESSION['update-admin']="<div class='suck2'>Admin updated successfully</div>";
        header('location:'.SITEURL.'admin/manage-admin.php');
    }
    else{
        $_SESSION['update-admin']="<div class='suck1'>Admin not updated</div>";
        header('location:'.SITEURL.'admin/manage-admin.php');
    }
}
